...
<!-- TODO: demo GIF — record `sb analyze` on a real Next.js repo and place it at
     assets/demo.gif, then uncomment. See docs/internal/launch/DEMO_PLAN.md. -->
<!-- ![sb analyze demo](assets/demo.gif) -->

> **Demo GIF coming soon.** In the meantime, the [Quick start](#quick-start)
> below shows real terminal output, and [docs/EXAMPLES.md](docs/EXAMPLES.md) has
> full runs against zod, axios, and fastify.

### Screenshots

<!-- TODO: add screenshots of the terminal report and the self-contained HTML
     report (`sb analyze --format html`) at assets/screenshot-*.png. -->
<!-- ![Terminal report](assets/screenshot-terminal.png) -->
<!-- ![HTML report](assets/screenshot-html.png) -->

_Screenshots of the terminal and HTML reports are on the way._
...
<!-- TODO: replace the ASCII pipeline above with a rendered SVG. The crate
     dependency graph can be generated by dogfooding `sb graph --format dot`.
     Place it at assets/architecture.svg and embed it here. -->
